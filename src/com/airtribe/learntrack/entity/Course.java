...
public class Course {
    ...
    public Course(int id, String courseName, int durationInWeeks) {
        this(id, courseName, "No description provided.", durationInWeeks);
    }
    ...
    public String toString() {
        return String.format("Course{id=%d, name='%s', duration=%d weeks, active=%s}",
                id, courseName, durationInWeeks, active);
    }
}
